...
| UCA channel mapping | A/.4 RX1 -> 0, A/.4 RX2 -> 1, B/.5 RX1 -> 2, B/.5 RX2 -> 3 | Required LibreSDR mapping, physically unverified | The same order is used by calibration, covariance, MUSIC, and the element-angle sequence. The physical antenna cables still have to match elements 0, 1, 2, 3 in that order. |
