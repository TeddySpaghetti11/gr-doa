...
# Title: Estimate constant phase offset & save
# Author: jreitmei
...
class estimate_constant_phase_offsets_and_save(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "Estimate constant phase offset & save", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Estimate constant phase offset & save")
        ...
        self.iio_fmcomms2_source_0_0 = iio.fmcomms2_source_fc32('ip:192.168.2.1', [True, True, True, True], 32768)
        ...
        self.iio_fmcomms2_source_0 = iio.fmcomms2_source_fc32('ip:192.168.3.1', [True, True, True, True], 32768)
        ...
        self.doa_phase_offset_est_0_0_0 = doa.phase_offset_est(2, input_variables.SkipAhead)
        self.doa_phase_offset_est_0_0 = doa.phase_offset_est(2, input_variables.SkipAhead)
        self.doa_findmax_and_save_0_0_0 = doa.findmax_and_save(input_variables.Samples2FindMax, 1, rel_phase_offsets_file_name)
        self.doa_findmax_and_save_0_0 = doa.findmax_and_save(input_variables.Samples2FindMax, 1, rel_phase_offsets_file_name)


        ##################################################
        # Connections
        ##################################################
        self.connect((self.doa_phase_offset_est_0_0, 0), (self.doa_findmax_and_save_0_0, 0))
        self.connect((self.doa_phase_offset_est_0_0_0, 0), (self.doa_findmax_and_save_0_0_0, 0))
        self.connect((self.iio_fmcomms2_source_0, 1), (self.doa_phase_offset_est_0_0, 1))
        self.connect((self.iio_fmcomms2_source_0, 0), (self.doa_phase_offset_est_0_0, 0))
        self.connect((self.iio_fmcomms2_source_0, 0), (self.qtgui_time_sink_x_0_1, 0))
        self.connect((self.iio_fmcomms2_source_0, 1), (self.qtgui_time_sink_x_0_1, 1))
        self.connect((self.iio_fmcomms2_source_0_0, 0), (self.doa_phase_offset_est_0_0_0, 0))
        self.connect((self.iio_fmcomms2_source_0_0, 1), (self.doa_phase_offset_est_0_0_0, 1))
        self.connect((self.iio_fmcomms2_source_0_0, 1), (self.qtgui_time_sink_x_0_1_0, 1))
        self.connect((self.iio_fmcomms2_source_0_0, 0), (self.qtgui_time_sink_x_0_1_0, 0))
