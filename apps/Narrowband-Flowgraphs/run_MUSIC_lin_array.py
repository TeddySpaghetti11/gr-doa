...
class run_MUSIC_lin_array(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "MUSIC linear array", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("MUSIC linear array")
        ...
        self.qtgui_vector_sink_f_0_0.set_y_axis((-60), 60)
        ...
        for i in range(input_variables.NumTargets):
            ...
            self.qtgui_number_sink_1_0.set_max(i, 180)
        ...
        self.doa_find_local_max_0_0 = doa.find_local_max(input_variables.NumTargets, input_variables.PSpectrumLength, 0.0, 180.0)
        ...
        self.doa_MUSIC_lin_array_0_0 = doa.MUSIC_lin_array(input_variables.NormSpacing, input_variables.NumTargets, input_variables.NumArrayElements, input_variables.PSpectrumLength)
        self.blocks_vector_to_streams_0_0 = blocks.vector_to_streams(gr.sizeof_float*1, input_variables.NumTargets)
        self.blocks_null_sink_0_0 = blocks.null_sink(gr.sizeof_float*input_variables.NumTargets)


        ##################################################
        # Connections
        ##################################################
        self.connect((self.blocks_vector_to_streams_0_0, 0), (self.qtgui_number_sink_1_0, 0))
        self.connect((self.doa_MUSIC_lin_array_0_0, 0), (self.doa_find_local_max_0_0, 0))
        self.connect((self.doa_MUSIC_lin_array_0_0, 0), (self.qtgui_vector_sink_f_0_0, 0))
        self.connect((self.doa_autocorrelate_0_0, 0), (self.doa_MUSIC_lin_array_0_0, 0))
        self.connect((self.doa_find_local_max_0_0, 0), (self.blocks_null_sink_0_0, 0))
        self.connect((self.doa_find_local_max_0_0, 1), (self.blocks_vector_to_streams_0_0, 0))
